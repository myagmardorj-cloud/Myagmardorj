...
> **H₀:** The observed correlation r = 0.6847 (zeros1) (earlier result — not reproduced across tested datasets) arises from normalization
...
8. No analytic derivation -- the empirical constant C ≈ 3 (preliminary) (earlier estimate)
