...
| Zero datasets | zeros_ht, zeros1, zeros6 | Odlyzko tables (zeros2/3/4 on server) |
...
## Expected Output (zeros1.txt)

```
Pearson r = 0.6847 (zeros1)
Naive p    = 2.64e-15   ← uncorrected, see LIMITATIONS.md
R(p) mean  varies (not constant; dataset-dependent)
