...
\title{Prime-Indexed Excess in High Riemann Zero\\
Spacing Statistics: A Numerical Study}
...
A statistically significant excess aligned with the first 12
prime frequencies was observed:
...
Strong numerical correlation was observed after normalization
and residual extraction. The ratio $R(p) = C(p)/B(p) \approx 16.5$
