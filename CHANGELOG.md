...
- `index.html`: "Fixing this gave r = 0.9992" → "Using the corrected normalization produced r ≈ 0.9992 in this dataset"
...
- `index.html`: removed `or-val good` (green bold) styling from r=0.9992 result row
